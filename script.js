...
function loadNotesData(arg) {
    ...
    if (target_ele.querySelector(".fa-list-ul")) {
    ...
    target_ele.innerHTML = ` <i class="fa-solid fa-list-ul"></i>
                            <div class="page-content page-text hide me-dis-flex-co"></div>`;
...
function loadPageText(item, target, level) {
    var div = document.createElement("div");
    div.className = "me-block me-dis-flex-co";
...
function loadPreviousMockResults() {
    ...
    mocks.forEach((mock, index) => {
        ...
        span2.className = "show-que link";
        span2.textContent = "Show questions";
        div_mock.appendChild(span2);
        span2.addEventListener("click", (event) => {
            showPrevMockQuestions(event, mock);
        });
    });
}

function showPrevMockQuestions(event, mock) {
    var div = document.querySelector(".index-tags .questions");
    div.innerHTML = "";
...
function getRandomPageHTMLTemplate() {
    return `<div class="middle main-questions">
                <div class="filter-tags-section">
                    <div class="head-filter-tag me-dis-flex">
                        <input type="text" class="search-filter input hide" placeholder="search filter tags" />
            ...
            <div class="support-me me-dis-flex">
...
function displayQuestion(que, tar_ele, type) {
    ...
    que.options.forEach((opt, index) => {
        ...
        span.addEventListener("click", (event) => {
            ...
            if (span.classList.contains("ans")) span.classList.add("correct-ans");
            else span.classList.add("wrong-ans");

            document.querySelectorAll(".option").forEach((optionSpan) => {
                if (optionSpan.classList.contains("ans")) optionSpan.classList.add("correct-ans");
            });
...
function addTagIndexList() {
    ...
    var tar_ele = document.querySelector(".index-tags .random");
